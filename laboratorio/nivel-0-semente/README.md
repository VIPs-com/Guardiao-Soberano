...
**Livro:** Capítulo 5 · `manuscrito/05-nivel-0-semente.md`

## Labs

| Arquivo | Descrição | Status |
| --- | --- | --- |
| `01-gerar-seed-dados.md` | Seed com dados + validação BIP39 offline | 🟡 Extraído — revalidar em hardware |
| `02-backup-aco.md` | Placa de aço + passphrase separada | 🟡 Extraído — revalidar em hardware |
