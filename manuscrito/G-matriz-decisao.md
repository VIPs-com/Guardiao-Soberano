...
## Qual software de swap usar?
  ...
  ------------------------------------ ----------------------- -----------------------------
  BTC → XMR (quero entrar no Monero)   eigenwallet             Detecta Tor automaticamente

  XMR → BTC (quero sair do Monero)     RetoSwap                P2P, sem KYC

  Fiat → XMR (comprar Monero direto)   Haveno (RetoSwap)       Descentralizado
...
## Qual ambiente usar para cada operação?
  ...
  Comprar sem KYC                     Tails + Feather/Cake para XMR; Tails + RoboSats para BTC
